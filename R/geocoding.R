...
geo_info <- function(tib)
{
  ...
  look_out <- c("lat", "lon", "city", "state", "county", "country", "GEOID", "GEOID_county")
  tib <- tib %>%
...
add_AQI <- function(tib)
{
  ...
  AQI_twenty_four <- read.csv("datasets/clean_AQI/AQI_twenty_four.csv")
  AQI_twenty_three <- read.csv("datasets/clean_AQI/AQI_twenty_three.csv")
  AQI_twenty_two <- read.csv("datasets/clean_AQI/AQI_twenty_two.csv")
  AQI_twenty_one <- read.csv("datasets/clean_AQI/AQI_twenty_one.csv")
  AQI_twenty <- read.csv("datasets/clean_AQI/AQI_twenty.csv")
  AQI_nineteen <- read.csv("datasets/clean_AQI/AQI_nineteen.csv")
  AQI_eighteen <- read.csv("datasets/clean_AQI/AQI_eighteen.csv")
  AQI_seventeen <- read.csv("datasets/clean_AQI/AQI_seventeen.csv")
  AQI_sixteen <- read.csv("datasets/clean_AQI/AQI_sixteen.csv")
  AQI_fifteen <- read.csv("datasets/clean_AQI/AQI_fifteen.csv")
  AQI_fourteen <- read.csv("datasets/clean_AQI/AQI_fourteen.csv")
  AQI_thirteen <- read.csv("datasets/clean_AQI/AQI_thirteen.csv")
  AQI_twelve <- read.csv("datasets/clean_AQI/AQI_twelve.csv")
  AQI_eleven <- read.csv("datasets/clean_AQI/AQI_eleven.csv")
  AQI_ten <- read.csv("datasets/clean_AQI/AQI_ten.csv")
  AQI_nine <- read.csv("datasets/clean_AQI/AQI_nine.csv")
  AQI_eight <- read.csv("datasets/clean_AQI/AQI_eight.csv")
  AQI_seven <- read.csv("datasets/clean_AQI/AQI_seven.csv")
  AQI_six <- read.csv("datasets/clean_AQI/AQI_six.csv")
  AQI_five <- read.csv("datasets/clean_AQI/AQI_five.csv")
  AQI_four <- read.csv("datasets/clean_AQI/AQI_four.csv")
  AQI_three <- read.csv("datasets/clean_AQI/AQI_three.csv")
  AQI_two <- read.csv("datasets/clean_AQI/AQI_two.csv")
  AQI_one <- read.csv("datasets/clean_AQI/AQI_one.csv")
  AQI_double_zero <- read.csv("datasets/clean_AQI/AQI_double_zero.csv")
  AQI_ninety_nine <- read.csv("datasets/clean_AQI/AQI_ninetynine.csv")
  AQI_ninety_eight <- read.csv("datasets/clean_AQI/AQI_ninetyeight.csv")
  AQI_ninety_seven <- read.csv("datasets/clean_AQI/AQI_ninetyseven.csv")
  AQI_ninety_six <- read.csv("datasets/clean_AQI/AQI_ninetysix.csv")
  AQI_ninety_five <- read.csv("datasets/clean_AQI/AQI_ninetyfive.csv")
  AQI_ninety_four <- read.csv("datasets/clean_AQI/AQI_ninetyfour.csv")
  AQI_ninety_three <- read.csv("datasets/clean_AQI/AQI_ninetythree.csv")
  AQI_ninety_two <- read.csv("datasets/clean_AQI/AQI_ninetytwo.csv")
  AQI_ninety_one <- read.csv("datasets/clean_AQI/AQI_ninetyone.csv")
  AQI_ninety <- read.csv("datasets/clean_AQI/AQI_ninety.csv")
  AQI_eighty_nine <- read.csv("datasets/clean_AQI/AQI_eightynine.csv")
  AQI_eighty_eight <- read.csv("datasets/clean_AQI/AQI_eightyeight.csv")
  AQI_eighty_seven <- read.csv("datasets/clean_AQI/AQI_eightyseven.csv")
  AQI_eighty_six <- read.csv("datasets/clean_AQI/AQI_eightysix.csv")
  AQI_eighty_five <- read.csv("datasets/clean_AQI/AQI_eightyfive.csv")
  AQI_eighty_four <- read.csv("datasets/clean_AQI/AQI_eightyfour.csv")
  AQI_eighty_three <- read.csv("datasets/clean_AQI/AQI_eightythree.csv")
  AQI_eighty_two <- read.csv("datasets/clean_AQI/AQI_eightytwo.csv")
  AQI_eighty_one <- read.csv("datasets/clean_AQI/AQI_eightyone.csv")
  AQI_eighty <- read.csv("datasets/clean_AQI/AQI_eighty.csv")
...
{
  atlas_stores <- read_excel("datasets/FoodEnvironmentAtlas.xls", sheet = "STORES")
  atlas_restaurants <- read_excel("datasets/FoodEnvironmentAtlas.xls", sheet = "RESTAURANTS")
...
{
  clean_twenty_four <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2024_clean.csv")
  clean_twenty_three <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2023_clean.csv")
  clean_twenty_two <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2022_clean.csv")
  clean_twenty_one <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2021_clean.csv")
  clean_twenty <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2020_clean.csv")
  clean_nineteen <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2019_clean.csv")
  clean_eighteen <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2018_clean.csv")
  clean_seventeen <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2017_clean.csv")
  clean_sixteen <- read.csv("datasets/EJ_index_data_clean/EJSCREEN_2016_clean.csv")
...
{
  consolidated <- read.csv("datasets/min_wage/consol_mw.csv", check.names = FALSE)
  change <- read.csv("datasets/min_wage/chg_in_mw.csv", check.names = FALSE)
...
{
  union_data <- read.csv("datasets/union/union_data.csv")
  tib <- tib %>%
